...
price.innerHTML = localization["<strong>{{price}}</strong><br>per month"].replace('{{price}}', '9.99$');
smallPrice.innerHTML = localization["{{price}}/month"].replace('{{price}}', '9.99$');
discountTag.innerHTML = localization["{{price}}/month"].replace('{{price}}', '9.99$');
